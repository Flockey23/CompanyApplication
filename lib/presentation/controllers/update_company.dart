...
class UpdateCompany {
  void updateCompany(
      ...
      updateCompanyState.companyForUpdate = ApiCompany(
          ...
          latitude: latitude,
          longitude: longitude);
      await updateCompanyState.updateCompany().then((value) => showResponse(updateCompanyState, context));
  }

  void showResponse(UpdateCompanyState updateCompanyState,BuildContext context) {
